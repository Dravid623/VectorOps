...
const similaritySearchWithScoreResults = await vectorStore1.similaritySearchWithScore("Access issues in the ABC dashboard analytics arose due to missing role configurations, affecting regional store leaders until proper roles were defined and permissions granted.", 2, filter);
